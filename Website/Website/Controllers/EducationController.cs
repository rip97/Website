...
{   
    ...
    {   
        ...
        public async Task<IActionResult> Create([Bind("EducationId,Degree,StartDate,EndDate,School")] Education education)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EducationId,Degree,StartDate,EndDate,School")] Education education)
        {
