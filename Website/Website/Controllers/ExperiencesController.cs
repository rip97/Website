...
{   
    ...
    public class ExperiencesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Description,StartDate,EndDate,ExperienceId,Title")] Experience experience)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Description,StartDate,EndDate,ExperienceId,Title")] Experience experience)
        {
